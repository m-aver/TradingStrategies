...
public class IndicatorsCalculationTests
{
    ...
    //хотя судя по опыту на реальных данных, все же на нее тоже нельзя однозначно ориентироваться
    [Theory]
    ...
    public static IEnumerable<object[]> GetUniformMonthReturnValues()
    {
        ...
        //хотя чисто визуально кривая выглядит лучше чем у отсортированного датасета
